...
echo ""
echo "Next:"
echo "  1. Launch Resident Evil 7 and load into gameplay."
echo "  2. Press Insert to open the REFramework menu."
echo "  3. Find the 'RE7 Personal Trainer' section and tick a cheat."
echo ""
echo "Cheats default to OFF and are never persisted. Each one validates itself"
echo "against the live game the first time you enable it, and states the reason"
echo "in the menu if it cannot. See README.md -> 'Using it'."
